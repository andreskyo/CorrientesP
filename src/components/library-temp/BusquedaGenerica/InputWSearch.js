...
class InputWSearch extends React.Component {
    ...
    render() {
        ...
        return (
        <Fragment>
            <InputSearch className={`col-lg-${size} col-sm-12 mb-2  `} >
                <div className="">
                    <div className={`input-group input-group-search-content  ${calsevalida} `}>
                        {this.renderBotonInput()}
                            <div className="input-group-append">
                                <Buttons size="large" text="Buscar" primary onClick={()=>this.handleClick()} > </Buttons>
                            </div>
                    </div>
                </div>
            </InputSearch>
...
InputWSearch.propTypes = {
    children: PropTypes.any,
    className: PropTypes.string
  }

export default InputWSearch;