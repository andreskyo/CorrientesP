    ...
    <div className="container">
      ...
      <div className="d-flex flex-column justify-content-center my-4">
        ...
        <div className='container my-5'>
            <p>Esta opción permite consultar los siguientes certificados, históricos y vigentes, emitidos para la cuit solicitada:</p>
            <ul>
                <li>
                Certificado Fiscal para Contratar
                </li>
                <li>
                Certificado de No Retención y No Percepción
                </li>
                <li>
